                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ...
                            ft.Text("No backup records found", color=self.palette.text_grey, size=14),
                        ],
    ...
    def monitor_status(self):
        while self.running:
            ...
            if is_running:
                ...
                icon.color = "#34C759"
                text.value = "Antigravity is running in background"
                text.color = "#34C759"
            else:
        ...
        def task():
            try:
                if switch_account(account_id):
                    ...
                    # self.show_message("Switch account successful")
                else:
                    self.show_message("Switch account failed, please check logs", True)
            except Exception as e:
                import traceback
        ...
        def confirm_delete():
            try:
                if delete_account(account_id):
                    ...
                    self.show_message("Delete account failed, please check logs", True)
            except Exception as e:
                import traceback
